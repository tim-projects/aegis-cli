...
def get_otps(vault_data: Vault) -> Dict[str, OTP]:
    ...
    for entry in vault_data.db.entries:
        try:
            ...
            print(
                f"Error generating OTP for entry {entry.uuid}: {e}"
